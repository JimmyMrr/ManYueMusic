 ...
 */
public class MusicInfoItem implements Parcelable {
    ...
    public static final Creator<MusicInfoItem> CREATOR = new Creator<MusicInfoItem>() {

        @Override
        public MusicInfoItem createFromParcel(Parcel source) {
            MusicInfoItem music = new MusicInfoItem();
        ...
        @Override
        public MusicInfoItem[] newArray(int size) {
            return new MusicInfoItem[size];
        }
    };
